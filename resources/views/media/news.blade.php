        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-6 m-b30">
                        <div class="icon-bx-wraper style-1">
                            <div class="icon-bx">
                       <img src="{{asset('/images/mycollection/png/002-news-feed.png')}}" width="50px">   
                            </div>
                    ...
                    <div class="col-sm-6 m-b30">
                        <div class="icon-bx-wraper style-1">
                            <div class="icon-bx">
                       <img src="{{asset('/images/mycollection/png/003-press.png')}}" width="50px">   
                            </div>
                            <div class="icon-content">
            ...
            <div class="col-lg-6 m-b30">
                <div class="dlab-media">
                    <img src="{{ asset('images/banner/news.webp') }}" alt="Latest News">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                <div class="dlab-box">
                    <div class="dlab-media">
                        <img src="{{ asset('images/our-work/oilgas/pic175.jpg') }}" alt="Sustainability Milestone">
                    </div>
                    <div class="dlab-info">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 m-b30">
                <div class="dlab-box">
                    <div class="dlab-media">
                        <img src="{{ asset('images/our-work/oilgas/pic176.jpg') }}" alt="Technology Innovation">
                    </div>
                    <div class="dlab-info">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 m-b30">
                <div class="dlab-box">
                    <div class="dlab-media">
                        <img src="{{ asset('images/our-work/oilgas/pic177.jpg') }}" alt="Community Initiative">
                    </div>
                    <div class="dlab-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 m-b30">
                <div class="dlab-box">
                    <div class="dlab-media">
                        <img src="{{ asset('images/our-work/oilgas/pic178.jpg') }}" alt="Safety Award">
                    </div>
                    <div class="dlab-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 m-b30">
                <div class="dlab-box">
                    <div class="dlab-media">
                        <img src="{{ asset('images/our-work/oilgas/pic179.jpg') }}" alt="Partnership">
                    </div>
                    <div class="dlab-info">
